	...
	<div id="wrap" class="container">
		<header>
			<div class="d-flex">
				<!-- 로고 영역 -->
				<div class="logo">
					<a class="logoText text-success" href="/template/quiz10.jsp">Melong</a>
				</div>
				
				<!-- 검색 영역 -->
				<div class="mb-3 col-4">
					<form method="get" action="/template/quiz10.jsp">
		...
		<section>
			...
			<article class="mt-3">
				...
				%>
						<tr>
							<td><%= music.get("id") %></td>
							<td><a href="/template/quiz10.jsp?musicId=<%= music.get("id") %>"><%= music.get("title") %></a></td>
