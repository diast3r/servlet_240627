...
footer {height:200px;}
.infoBox {border:1px solid #28a745; height:fit-content;}
</style>
</head>
<body>
<%
...
%>
	<div id="wrap" class="container">
		<header class="d-flex align-items-center">
			<%-- 로고 영역 --%>
			<div class="col-2">
				<h3><a href="/lesson02/quiz10_answer1.jsp" class="text-success">Melong</a></h3>
			</div>
			<%-- 검색 영역 --%>
		...
		<section class="contents">
			...
			<div class="d-flex border border-success p-3">
				<%-- 이미지 --%>
				<div>
					<img src="<%= artistInfo.get("photo") %>" alt="가수 사진" width="150">
				</div>
				<%-- 가수 정보 --%>
				<div class="ml-3">
			...
			<div class="music-list mt-3">
				...
				<table class="table mb-0">
					...
					%>
						<tr>
							<td><%= music.get("id") %></td>
							<td><a href="/lesson02/quiz10_answer2.jsp?id=<%= music.get("id") %>"><%= music.get("title") %></a></td>
